...
class SourceWidget(QWidget):
    ...
    def __init__(
        ...
        controller.conversation_deletion_successful.connect(
            self._on_conversation_deletion_successsful
        )
        ...
        self.selected = False
        self.deletion_scheduled_timestamp = None
        self.sync_started_timestamp = None
    ...
    def update(self) -> None:
        ...
        if (
            self.sync_started_timestamp
            and self.deletion_scheduled_timestamp
            and self.sync_started_timestamp < self.deletion_scheduled_timestamp
        ):
            return
    ...
    def _on_conversation_deletion_successsful(self, source_uuid: str, timestamp: datetime) -> None:
        if self.source_uuid == source_uuid:
...
class SourceConversationWrapper(QWidget):
    ...
    def __init__(self, source: Source, controller: Controller) -> None:
        ...
        controller.conversation_deletion_successful.connect(self._on_conversation_deletion_successful)
